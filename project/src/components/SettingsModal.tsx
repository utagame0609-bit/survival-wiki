  ...
  return (
    <>
      <button
        ...
        aria-label="設定"
        className="fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#292b24] text-stone-200 border border-[#3a3d34] shadow-lg shadow-black/30 hover:bg-[#34372e] active:scale-95 transition-all"
      >
