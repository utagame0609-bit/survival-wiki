      ...
      <div className="bg-[#141416] p-3 sm:p-6 lg:p-8">
        <div className="mx-auto w-full max-w-[96rem] space-y-4 sm:space-y-5">
          ...
          <div className="lg:hidden">
            ...
            <div className="mt-4"><DossierBodyPaper {...bodyPaperProps} /></div>
          </div>
          ...
          <div className="hidden space-y-5 lg:block">
            ...
            <DossierBodyPaper {...bodyPaperProps} />
          </div>
...
function DossierBodyPaper({ dossier, evidencePhotos, activeCarouselIdx, setActiveCarouselIdx, indexOpen, setIndexOpen, declassifiedMode, setSelectedPhoto }: BodyPaperProps) {
