...
export function LocationFormModal({ world, mode, editingLocation, saving, onSave, onComplete, onCancel }: LocationFormModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/85 backdrop-blur-sm" onMouseDown={(event) => {
      ...
      <div className="relative w-full max-w-xl max-h-[90vh] overflow-hidden bg-[#161b27] border-2 border-amber-500 shadow-[0_0_40px_rgba(245,158,11,0.14)] motion-safe:animate-[modal-enter_180ms_cubic-bezier(.22,.8,.35,1)]">
        ...
        <div className="max-h-[calc(90vh-70px)] overflow-y-auto overscroll-contain">
