...
import { ChevronDown, Camera, X, Compass, Users, Check } from 'lucide-react';
...
export function LocationForm({ members, editing, onSave, onComplete, onCancel, saving }: Props) {
  ...
  return (
    <div className="px-4 sm:px-5 py-4 sm:py-5 max-w-3xl mx-auto space-y-4 text-slate-100 font-mono">
      ...
      <div>
        <label className="block text-xs font-bold text-slate-300 mb-1.5 uppercase tracking-wider flex items-center gap-1.5"><Camera className="w-4 h-4 text-amber-400" />TACTICAL PHOTO // 記録写真</label>
        {mainPreview ? (
