      ...
      {!loading && locations.length > 0 && <>
        <div className="flex justify-between items-center px-1 mb-2.5 text-[11px] text-stone-500 font-mono gap-3">
          <div className="flex items-center gap-2 min-w-0">
            <button type="button" onClick={() => { playChestOpenSound(); setCollectionOpen(true); }} aria-label="コレクションを開く" title="コレクション" className="group shrink-0 w-9 h-8 rounded-lg border border-emerald-900/60 bg-emerald-950/20 hover:border-emerald-600/70 hover:bg-emerald-950/30 active:scale-[0.96] transition-all flex items-center justify-center">
